...
public class SpringMVCController_no_autoWarp_Test {
	...
	public void queryModel() throws Exception {
		...
		.andExpect(jsonPath("$.createDate").value("2015-07-27 12:00:00"))
	...
	public void queryCycleList() throws Exception {
		...
		.andExpect(jsonPath("$.[0]createDate").value("2015-07-27 12:00:00"))
	...
	public void filterProperty() throws Exception {
		...
		.andExpect(jsonPath("$.root.createDate").value("2015-07-27 12:00:00"))
	...
	public void filterPropertyList() throws Exception {
		...
		.andExpect(jsonPath("$.root[0].createDate").value("2015-07-27 12:00:00"))
	...
	public void bindModel() throws Exception {//.content("{name:'parent',id:1,createDate:"+((new Date()).toString()+",age:11}")
		...
		.andExpect(jsonPath("$.name").value("parent"))
		.andExpect(jsonPath("$.id").value(1))
		.andExpect(jsonPath("$.createDate").value("2012-11-11 12:00:00"))
		.andExpect(jsonPath("$.age").value(11))
...
//		.andExpect(jsonPath("$.wheres[0].ignoreCase").value(true))
//		.andExpect(jsonPath("$.wheres[1].prop").value("age"))
//		.andExpect(jsonPath("$.wheres[1].value").value(10))
//		.andExpect(jsonPath("$.wheres[1].op").value("<"))
...
//				.param("wheres[0].prop", "name")
//				.param("wheres[0].op", "like")
