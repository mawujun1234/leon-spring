 ...
 *
 */
public class JSONView_FastJson extends AbstractView {
...
//		2:还要测试直接返回实体类
		...
		FileCopyUtils.copy(JSON.toJSONString(o), new OutputStreamWriter(response.getOutputStream(), this.getEncoding()));
...
//	}
	...
	public String getContentType() {
		return JSONView_FastJson.DEFAULT_CONTENT_TYPE;
	}
